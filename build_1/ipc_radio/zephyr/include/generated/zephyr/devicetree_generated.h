 ...
 *
 * DTS input file:
 *   C:/Users/User/Downloads/Montre_Connectee/build_1/ipc_radio/zephyr/zephyr.dts.pre
 *
 * Directories with bindings:
 *   C:/ncs/v2.8.0/nrf/dts/bindings, $ZEPHYR_BASE\dts\bindings
 *
...
/* Helpers for dealing with node labels: */
#define DT_N_S_soc_S_dppic_4100f000_NODELABEL_NUM 1
#define DT_N_S_soc_S_dppic_4100f000_FOREACH_NODELABEL(fn) fn(dppic)
#define DT_N_S_soc_S_dppic_4100f000_FOREACH_NODELABEL_VARGS(fn, ...) fn(dppic, __VA_ARGS__)
 ...
 *   C:/ncs/v2.8.0/nrf/dts/bindings\bluetooth\nordic,bt-hci-sdc.yaml
 *
 * (Descriptions have moved to the Devicetree Bindings Index
 * in the documentation.)
 */
